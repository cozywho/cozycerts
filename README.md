...
A self contained CA intended to work in a venv. Dont use this in prod unless its ONLY for cert gen. At least until I come up with a good way to handle CA accessability.
